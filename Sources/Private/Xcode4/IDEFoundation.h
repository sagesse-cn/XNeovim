...
@protocol IDEIntegrityLogDataSource <NSObject>
...
@protocol DVTPerformanceTestParser <NSObject>
- (BOOL)performanceTestOutput:(id *)arg1 forInputString:(id)arg2;
@end

@protocol DVTReferenceResolverClient <NSObject>
- (void)resolverStrategiesDidChange:(id)arg1;
@end

/*
 xcode9/swift4: Command failed due to signal: Abort trap: 6
...
@protocol IDEIndexDatabaseDelegate <NSObject>
...
@interface IDEConsoleItem : NSObject
{
